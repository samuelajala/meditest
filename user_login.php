...
<body>
 ...
 <!-- Navbar
    ...
    <a class="brand" data-trigger="hover" id="#ad" title="&copy; 2017" data-placement="bottom" data-content="Medical Test System" data-toggle="popover" href="#">Medical System</a>
...
<div class="input-prepend">
  ...
  <button class="btn dropdown-toggle" data-toggle="dropdown"> Health Menu <span class="caret"></span></button>
        <ul class="dropdown-menu">
            <li><a href="view_details.php" ><i class="icon-plus-sign"></i>Conduct Test</a></li>
