...
<title>Medical Test System System | Admin</title>
</head>
...
<body>
 ...
 <!-- Navbar
   ...
   <a class="brand" data-trigger="hover" id="#ad" title="&copy; 2015" data-placement="bottom" data-content="Medical Test System" data-toggle="popover" href="#">Medical System</a>
...
<div style="margin-top:15px;" class="container thumbnail">
            ...
            <pre><h4><strong><i class="icon-user"></i> Patients Details</strong></h4></pre>
 		...
 		<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                <thead>
                    ...
                    <?php
    $query = mysqli_query($conn,"select * from customer_tb") or die(mysql_error());
                ...
                <tbody>
                						<tr> 	 	 	 	 	 	 	 
                                           ...
                                           <td><a href="admin.php" class="btn btn-info" role="button" data-toggle=""><i class="icon-check"></i> Back</a>
                                                </form>
