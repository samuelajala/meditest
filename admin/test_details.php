...
<title>Medical Test System System | Types</title>
</head>
...
<body>
 ...
 <!-- Navbar
   ...
   <a class="brand" data-trigger="hover" id="#ad" title="&copy; 2016" data-placement="bottom" data-content="Medical Test System" data-toggle="popover" href="#">Medical System</a>
...
<div style="margin-top:15px;" class="container thumbnail">
            ...
            <pre><h4><strong><i class="icon-user"></i> Test Types Details</strong></h4></pre>
    ...
    $query = mysqli_query($conn,"select * from cat_tb") or die(mysql_error());
                ...
                <tbody>
                						<tr> 	 	 	 	 	 	 	 
                                            ...
                                            <td><a href="edit_test.php?id=<?php echo $cat_id;?>" class="btn btn-info" role="button" data-toggle=""><i class="icon-check"></i> Edit</a>
                                                </form>
