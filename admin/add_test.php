...
<!--sa calendar-->	
   ...
   <a class="brand" data-trigger="hover" id="#ad" title="&copy; 2015" data-placement="bottom" data-content="Medical Test System" data-toggle="popover" href="#">Medical Test System</a>
...
<header class="jumbotron subhead" id="overview" name="overview">
  ...
  <body>
   ...
   ADDING TEST TYPES
                  ...
                  <td>Name:                     
                   <input name="name" type="text"  placeholder="Enter Type" id="name"/></td>
                   <td>Symptoms:
                    <textarea name="sym" id="sym"></textarea>
                  </td>
                 ...
                 <td>Drug Prescription:                     
                   ...
                   <textarea name="drug" placeholder="Enter Drug" id="drug"></textarea> 
                   <td>Description:
                  <input name="desc" type="text"  placeholder="Description" id="desc"/></td>
          ...
          <td>
             ...
             <?php
                            if (isset($_POST['create'])) {
                               ...
                               $query="INSERT INTO cat_tb (name,symptoms,drugs,description) VALUES ('$name','$sym','$drug',$desc')";
              ...
              if($result) 
              {
                ...
                echo '<p class="alert alert-danger">Error Occurred while trying to Add Type. Please Try Again</p>';
